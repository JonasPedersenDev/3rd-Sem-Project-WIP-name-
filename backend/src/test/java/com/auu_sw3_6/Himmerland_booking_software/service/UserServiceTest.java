 ...
 * import
 * com.auu_sw3_6.Himmerland_booking_software.api.repository.UserBaseRepository;
 * 
 ...
 * @BeforeEach
 * public void setUp() {
 * userService = new UserService<ConcreteUser>(repository,
 * profilePictureService, passwordEncoder) {};
 ...
 * 
 * // Mark profilePicture mock as lenient to avoid issues in tests that don't
 * use it
 ...
 * @Test
 * public void
 * testCreateUser_withProfilePicture_shouldSaveUserWithEncodedPassword() throws
 * Exception {
 * // Arrange
 * when(profilePictureService.saveProfilePicture(profilePicture)).thenReturn(
 * "uniqueProfile.jpg");
 * when(passwordEncoder.encode("rawPassword123")).thenReturn(
 * "encodedPassword123");
