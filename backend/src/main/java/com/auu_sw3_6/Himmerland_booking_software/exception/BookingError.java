...
public enum BookingError {
  ...
  PICKUP_TIME_IN_PAST("Afhentningstidspunkt skal være i fremtiden for startdatoen.", 1003),
  ...
  ACTIVE_BOOKING_START_EDIT("Kan ikke ændre startdatoen for aktiv booking.", 2007),
